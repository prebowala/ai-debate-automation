...
VOICE_A_ID = "TDLo7essLth41zzKX1tJ"  # Replace with your Voice ID
VOICE_B_ID = "ukqx2suWsNQ1vu8lj2IC"  # Replace with your Voice ID
...
def clean_json_string(text):
    """Strips markdown block wrappers like ```json ... ```"""
...
def generate_debate():
    ...
    # Print exact error if OpenRouter fails
    if "error" in data:
...
if __name__ == "__main__":
    ...
    make_audio(script)
    print("Execution complete! output_audio.mp3 and scores.json generated.")
